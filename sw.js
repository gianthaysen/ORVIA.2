...
const ASSETS = ['./','./index.html','./styles.css','./manifest.webmanifest',
  ...
  './js/config.js','./js/supplements.js','./js/calc.js','./js/data.js','./js/profile.js','./js/issues.js','./js/intelligence.js','./js/orvia-pro.js','./js/charts.js','./js/ui.js','./js/activity.js','./js/nutrition.js','./js/insights.js','./js/race.js','./js/strava-real-data.js','./js/story.js','./js/extras.js','./js/sync.js','./js/auth.js'];
