...
const ASSETS = ['./','./index.html','./styles.css','./manifest.webmanifest',
  ...
  './js/config.js','./js/supplements.js','./js/calc.js','./js/data.js','./js/profile.js','./js/issues.js','./js/intelligence.js','./js/orvia-pro.js','./js/charts.js','./js/ui.js','./js/sync.js','./js/auth.js'];
