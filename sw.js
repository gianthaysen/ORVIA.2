...
const ASSETS = ['./','./index.html','./styles.css','./manifest.webmanifest',
  ...
  './js/repos/repoBase.js','./js/repos/profileRepository.js','./js/repos/checkinRepository.js','./js/repos/trainingLoadRepository.js','./js/repos/readinessRepository.js','./js/repos/goalRepository.js','./js/repos/availabilityRepository.js','./js/offline-queue.js','./js/migrate-blob.js','./js/readiness-source.js',
  './js/sync.js','./js/auth.js'];
