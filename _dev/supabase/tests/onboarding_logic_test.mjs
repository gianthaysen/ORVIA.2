...
await import(new URL('../../../app/js/onboarding/onboarding-profile-logic.js', import.meta.url)); // für profileValid-Guard
await import(new URL('../../../app/js/onboarding/onboarding-sports-logic.js', import.meta.url)); // für sportsValid-Guard
await import(new URL('../../../app/js/profile-model.js', import.meta.url)); // M6: für goalsValid-Guard
const L = (await import(new URL('../../../app/js/onboarding/onboarding-logic.js', import.meta.url))).default;
