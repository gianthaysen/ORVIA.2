...
const act = readFileSync(new URL('../../../app/js/activity.js', import.meta.url), 'utf8');
const prof = readFileSync(new URL('../../../app/js/profile.js', import.meta.url), 'utf8');
const xtra = readFileSync(new URL('../../../app/js/checkin-extra.js', import.meta.url), 'utf8');
