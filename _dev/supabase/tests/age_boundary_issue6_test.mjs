...
await import(new URL('../../../app/js/clock.js', import.meta.url));
const P = (await import(new URL('../../../app/js/onboarding/onboarding-profile-logic.js', import.meta.url))).default;
...
await import(new URL('../../../app/js/profile-store.js', import.meta.url));
...
const storeSrc = readFileSync(new URL('../../../app/js/profile-store.js', import.meta.url), 'utf8');
