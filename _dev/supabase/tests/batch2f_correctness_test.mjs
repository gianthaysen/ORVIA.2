...
/* ---------- P: markPlannedDone fail-closed (Punkt 2) ---------- */
{
  ...
  const s1 = mkSb();
  const r1 = s1.markPlannedDone('Laufen', 2, 0);
  ...
  const r2 = s2.markPlannedDone('Laufen', 2, 0);
  ...
  const s4 = mkSb();
  const r4 = s4.markPlannedDone('Laufen', 4, 0);
  ...
  const r5 = s5.markPlannedDone('Laufen', 2, 0);
  ...
  const r6 = s6.markPlannedDone('Laufen', 2, 0);
  ...
  const r6b = s6b.markPlannedDone('Laufen', 2, 0);
  ...
  const r7 = s7.markPlannedDone('Laufen', 2, 0);
  ...
  const s8 = mkSb();
  const r8 = s8.markPlannedDone('Laufen', 2, 0);
  ...
  const r9 = s9.markPlannedDone('Laufen', 2, 0);
  ...
  const r10 = s10.markPlannedDone('Laufen', 2, 0);
  ...
  const r11 = s11.markPlannedDone('Laufen', 2, 0);
  ...
  const r11b = s11b.markPlannedDone('Laufen', 2, 0);
  ...
  const r12 = s12.markPlannedDone('Laufen', 2, 0);
