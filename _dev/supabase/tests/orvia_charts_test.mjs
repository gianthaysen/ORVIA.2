...
let M=null;
try{ M=(await import(new URL('../../../app/js/orvia-charts.js',import.meta.url))).default; }catch(e){}
...
const src=(()=>{try{return R('../../../app/js/orvia-charts.js');}catch(e){return '';}})();
