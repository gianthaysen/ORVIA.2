...
function makeSb(opts) {
  ...
  sb.ORVIA = { workoutUI: { openTrainingTab: () => calls.push('openTrainingTab') } };
  ...
  vm.createContext(sb);
  vm.runInContext(readFileSync(new URL('../../../app/js/quick-actions.js', import.meta.url), 'utf8'), sb, { filename: 'quick-actions.js' });
...
{ // Registry-Verträge
  ...
  const src = readFileSync(new URL('../../../app/js/quick-actions.js', import.meta.url), 'utf8');
