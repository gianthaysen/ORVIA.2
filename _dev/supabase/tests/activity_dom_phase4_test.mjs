...
const G=globalThis;
(0,eval)(fs.readFileSync(new URL('../../../app/js/calc.js',import.meta.url),'utf8'));
const C=G.Calc;
...
(0,eval)(fs.readFileSync(new URL('../../../app/js/story.js',import.meta.url),'utf8'));
(0,eval)(fs.readFileSync(new URL('../../../app/js/activity.js',import.meta.url),'utf8'));
