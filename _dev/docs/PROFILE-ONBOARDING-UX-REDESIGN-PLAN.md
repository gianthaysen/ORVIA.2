...
| M5b/M5c ✅ | UMGESETZT 2026-07-03: A2-Redesign (ChoiceCard-Grid+Hauptsport) + A3 Trainingsstand (training_level-Step, sports[primary].level/sessionsPerWeek, Bänder) + A7 Körper (body-Step aktiv, skippbar, D7-Defaults entfernt). Tests: onboarding_m5b_training 73/73 + m7-Suite. | erledigt |
| M6 ✅ | UMGESETZT 2026-07-03: Draft v4 (Placeholder-Ablösung), Essential-Zielschritt (16 kuratierte Karten in 4 Gruppen, EIN Ziel, Auto-Titel, validateEssentialGoals). Tests 38/38. | erledigt |
| M7 ✅ | UMGESETZT 2026-07-03: Verfügbarkeit kompakt (leere Woche als Start!) + Sicherheits-Check (constraintsAcknowledgedAt/constraintsList) als eigene Steps. Tests 59/59. | erledigt |
| M8 ✅ | UMGESETZT 2026-07-03: ReviewCards + ehrliche Completeness + Erfolgsscreen mit Check-in-CTA (ageEstimate-Mapping-Fix). Ebene-B-Modul-Liste offen (Hinweis-Text statt toter CTA). Tests 16/16. | erledigt |
| M9 ✅ | UMGESETZT 2026-07-03: Check-in-Spotlight (coachmarks.js, user-scoped, einmalig, dismissbar, reset()). Weitere Tab-Coachmarks offen. Tests 13/13. | erledigt (Kern) |
| M10 ✅ | UMGESETZT 2026-07-03: profile-center.js (Header+Ring, max 2 Smart Prompts, 4 Gruppen, Status-Chips, planImpact; nur lesend, Delegation openProfileSection). Tests 33/33. | erledigt |
