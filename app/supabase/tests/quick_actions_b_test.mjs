...
function makeSb(opts) {
  ...
  vm.createContext(sb);
  vm.runInContext(readFileSync(new URL('../../js/quick-actions.js', import.meta.url), 'utf8'), sb, { filename: 'quick-actions.js' });
...
{ // Registry-Verträge
  ...
  const src = readFileSync(new URL('../../js/quick-actions.js', import.meta.url), 'utf8');
