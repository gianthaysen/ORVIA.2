...
(function (root) {
  ...
  /* S1/E1 (12.09.2026): Bestzeiten je SPORT und Standarddistanz. Befund Produktionskonto: ein
  ...
  /* Sportfamilie einer Aktivitaet fuer die Bestzeiten: running | cycling | swimming | null. */
  ...
  function measuredBests(activities, opts) {
    opts = opts || {};
    ...
    var res = { sport: sport, scanned: 0, withSplits: 0, withStreams: 0, withDerivedTime: 0, slack: slack };
    targets.forEach(function (t) { res[t.key] = null; });
    var list = Array.isArray(activities) ? activities : [];
    list.forEach(function (a) {
      if (sportFamily(a) !== sport) return;
  ...
  var api = {
    TARGETS: TARGETS, SPORT_TARGETS: SPORT_TARGETS, SLACK: SLACK, sportFamily: sportFamily,
