...
-- Defensive Absicherung gegen doppelte Relationszeilen (Constraint existiert bereits in 0003,
-- hier idempotent verstärkt) — verhindert versehentliche Vervielfachung des Volumens.
create unique index if not exists exercise_muscles_uniq on public.exercise_muscles (exercise_id, muscle_key);
