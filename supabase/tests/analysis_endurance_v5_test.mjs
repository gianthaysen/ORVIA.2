...
const html=R(_APPREL + 'index.html'), ui=inlined(R(_APPREL + 'js/ui.js')), css=R(_APPREL + 'styles.css');
const mod=(()=>{try{return R(_APPREL + 'js/orvia-charts.js');}catch(e){return '';}})();
