...
{
  const auth = readFileSync(new URL(_APPREL + 'js/auth.js', import.meta.url), 'utf8');
  ...
  await (async function behaviorTestE7c() {
    ...
    vm.runInContext(readFileSync(new URL(_APPREL + 'js/auth.js', import.meta.url), 'utf8'), sb2, { filename: 'auth.js' });
