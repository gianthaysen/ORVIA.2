...
globalThis.ORVIA.trainingDomain = { normSport: v => { const s = String(v || '').toLowerCase(); const m = { laufen: 'running', rad: 'cycling', schwimmen: 'swimming', krafttraining: 'gym', 'mobilität': 'gym', fußball: 'football', paddel: 'padel' }; return m[s] || s; } };
