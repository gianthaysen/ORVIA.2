...
await wait();
ok('edit:true reopen → bearbeitbare Profilformulare (kein Done-Screen)', (card(h).innerHTML || '').indexOf('Einrichtung vorgemerkt') < 0 && (card(h).innerHTML || '').indexOf('Deine Sportarten') < 0 && !!h.byId('pf-displayName'));
