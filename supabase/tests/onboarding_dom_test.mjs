...
await import(new URL(_APPREL + 'js/profile-model.js', import.meta.url));   // M6: goalsValid-Guard + Ziel-Renderer
...
await import(new URL(_APPREL + 'js/profile-ui-kit.js', import.meta.url));   // M5a: A1 nutzt das UI-Kit (fail-closed ohne Kit)
await import(new URL(_APPREL + 'js/onboarding/onboarding-ui.js', import.meta.url)); // einmal; document-Zugriff ist dynamisch
