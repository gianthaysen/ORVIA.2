...
// Altersgrenzen exakt
function bdAge(years, extraDays) { const d = new Date(TODAY); d.setFullYear(d.getFullYear() - years); if (extraDays) d.setDate(d.getDate() + extraDays); return d.toISOString().slice(0, 10); }
