...
try { P.planEntryClick(2, 0, P.todayStr()); } catch (e) { ok('[AD1-5u] planEntryClick unique wirft nicht', false, e.message); }
...
try { P.planEntryClick(2, 0, P.todayStr()); } catch (e) {}
...
PM.markPlannedDone('Gym', 2, 0, PM.todayStr());
