...
function makeApp() {
  ...
  ['i18n.js', '../locales/de.js', 'profile-model.js', 'onboarding/onboarding-profile-logic.js', 'onboarding/onboarding-sports-logic.js', 'profile.js', 'profile-center.js'].forEach(f =>
...
{
  const css = readFileSync(new URL(_APPREL + 'styles.css', import.meta.url), 'utf8');
  const html = readFileSync(new URL(_APPREL + 'index.html', import.meta.url), 'utf8');
