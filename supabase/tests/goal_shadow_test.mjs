...
/* F · 'session' (@2, 12.09.2026): Laufzeit-Beleg ohne Zielmutation. Acht Tage Flag-Betrieb
...
console.log('\nF · session-Ereignis');
{
  ...
  const b = GS.build({ ...BASIS, eventType: 'session', eventId: 'gs_f', mainGoal: ZIEL, legacyGoal: LEGACY });
