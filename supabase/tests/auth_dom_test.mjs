...
function harness(opts) {
  ...
  const sb = {
    auth: {
      ...
      signInWithPassword() { return Promise.resolve({ data: { session: null } }); },
    ...
    from() { spies.from = true; return builder; }, functions: { invoke() { return Promise.resolve({ data: null }); } }
  };
  const documentEl = {
  ...
  return { reg, regGet, spies, win, documentEl, fireAuth: (evt, s) => authCb && authCb(evt, s), err };
}
