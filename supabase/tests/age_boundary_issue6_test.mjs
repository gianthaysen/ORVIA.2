...
await import(new URL(_APPREL + 'js/clock.js', import.meta.url));
const P = (await import(new URL(_APPREL + 'js/onboarding/onboarding-profile-logic.js', import.meta.url))).default;
...
await import(new URL(_APPREL + 'js/profile-store.js', import.meta.url));
...
const storeSrc = readFileSync(new URL(_APPREL + 'js/profile-store.js', import.meta.url), 'utf8');
