...
if(blk){
  ...
  if(evalOk){
    ...
    /* G1 (2026-08-07): fuenfte Zeile „Leistungsdaten". Bewusst als Aenderung
       nachgezogen, nicht gelockert — die Zeilenzahl bleibt exakt geprueft, damit
       eine unbeabsichtigte Zeile weiterhin auffaellt. */
    ok('Leistung: exakt 5 Zeilen (Leistungsdaten/Bestzeiten/Medaillen/Meilensteine/Pace-Rechner)', (grp2.match(/setting-item/g)||[]).length===5&&/Leistungsdaten/.test(grp2)&&/Bestzeiten/.test(grp2)&&/Medaillen/.test(grp2)&&/Meilensteine/.test(grp2)&&/Pace-Rechner/.test(grp2));
