...
/* ============================================================
   ...
   - DIREKTER BETA-ZUGANG: Public Signups bleiben AUS. Der User wird
     serverseitig direkt als bestätigt angelegt (email_confirm: true).
     Keine Magiclink-/Resend-Bestätigung über public Auth.
   ============================================================ */

// Beta: Kein E-Mail-Bestätigungsschritt. User wird direkt bestätigt angelegt.
const REQUIRE_EMAIL_CONFIRM = false;
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const created = await admin.auth.admin.createUser({
      email,
      password,
      email_confirm: true, // Beta: User direkt bestätigt, kein Magiclink/Resend.
