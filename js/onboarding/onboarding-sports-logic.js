...
(function (root) {
  ...
  var SEED_ALIASES = {
    ...
    gym: 'gym', kraft: 'gym', krafttraining: 'gym', strength: 'gym', 'mobilität': 'gym', mobilitaet: 'gym', mobility: 'gym', yoga: 'other',
  ...
  var VALID_CATEGORIES = ['endurance', 'strength', 'team', 'racket', 'outdoor', 'other'];
  ...
  var api = {
    ...
    setPrimarySport: setPrimarySport, toggleSport: toggleSport, setSportRole: setSportRole, setPlanningEnabled: setPlanningEnabled, setVisible: setVisible,
