...
(function (root) {
  ...
  var S = { draft: null, userId: null, el: null, busy: false, lastNav: 0, corruptNote: false, bound: false, previousFocus: null, profileSubmitted: false, heightDirty: false, weightDirty: false, reviewError: '' };
  var NAV_LOCK_MS = 300;
  ...
  O.onboardingV2 = {
    ...
    _reset: function () { S.draft = null; S.el = null; S.busy = false; S.lastNav = 0; S.corruptNote = false; S.previousFocus = null; S.profileSubmitted = false; S.heightDirty = false; S.weightDirty = false; S.reviewError = ''; }
  };
