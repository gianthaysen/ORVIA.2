...
(function (root) {
  ...
  function finishOnboarding() {
    var M = PM(); var dd = S.draft.draftData || {}; _collectGoals(); _collectSchedule();
    var pf = dd.profile || {}; var patch = {};
    ...
    if (P && P.updateSection) { if (P.load) P.load(); P.updateSection('onboarding', patch, ['personal', 'sports', 'goals', 'availability']); if (P.markOnboardingComplete) P.markOnboardingComplete(); }
    S.draft.status = 'completed'; S.draft.completedAt = now(); persist();
    closeShell();
  }
