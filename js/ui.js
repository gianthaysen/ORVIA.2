...
function gatherMorning(){return{sleepMin:+v('m_sleep'),sleepQ:+v('m_sleepQ'),
  ...
  knee:(document.getElementById('m_knee')?+v('m_knee'):null),feel:+v('m_feel'),legs:+v('m_legs'),ankle:(document.getElementById('m_ankle')?+v('m_ankle'):null),doms:+v('m_doms'),ts:Date.now()};}
