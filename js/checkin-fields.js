/* ============================================================
   ...
   Felder je Eintrag:
     ...
     label      UI-Label
     kind       sleep | range | number | chipsText | chipsBool | note | issues
     ...
     autoMaxAgeDays  max. Alter (Kalendertage) eines Garmin-Werts, um die
                Frage zu ersetzen (Schlaf/HFR/HRV: letzte Nacht ⇒ 1;
                Body Battery: nur tagesaktuell ⇒ 0)
...
(function () {
  ...
  var MORNING = [
    { key: 'sleepMin', el: 'm_sleep', label: 'Schlaf-Dauer', kind: 'sleep',
      ...
      metricId: 'sleep_duration_min', autoMaxAgeDays: 1, autoUnit: 'sleep',
    ...
    { key: 'rhr', el: 'm_rhr', label: 'Ruhepuls (bpm)', kind: 'number',
      ...
      table: 'resting_hr', metricId: 'resting_hr', autoMaxAgeDays: 1, autoUnit: 'bpm' },
    ...
    { key: 'hrvMs', el: 'm_hrvMs', label: 'HRV (ms)', kind: 'number',
      ...
      table: 'hrv_ms', metricId: 'hrv_ms', autoMaxAgeDays: 1, autoUnit: 'ms' },
    { key: 'hrv', el: 'm_hrv', label: 'HRV-Status (Garmin)', kind: 'chipsText',
      opts: ['Good', 'Balanced', 'Low'], table: 'hrv_status',
      metricId: 'hrv_status', autoMaxAgeDays: 1, autoUnit: 'text' },
