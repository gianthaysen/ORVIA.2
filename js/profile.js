...
function openConstraintsEditor(){window._cmgr=true;var list=_constraintList();
  ...
  _modal('_cstrMgr','<h3>Beschwerden und Einschränkungen</h3><p class="note" style="text-align:left">Hinweis: ORVIA gibt keine Diagnose und keine medizinische Behandlungsempfehlung.</p>'+ack+
