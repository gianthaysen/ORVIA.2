...
function renderProfileScreen(){
  ...
  el.innerHTML='<div class="profhead"><div class="avatar" onclick="changeProfilePhoto()" title="Foto ändern">'+ava+'</div>'+
    ...
    '<button class="editbtn" onclick="openOrviaOnboarding({fresh:false,edit:true,source:\'profile\'})" aria-label="Profil bearbeiten"><svg class="ic"><use href="#i-gear"/></svg></button></div>'+
    goalsSummaryHTML()+
