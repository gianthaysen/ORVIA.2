...
var PROFILE_DEFAULTS={
  v:1, onboarded:true,
  name:'Gian Thaysen', location:'Flensburg', age:22, sex:'m',
  weightKg:75, heightCm:182, hfMax:201, rhrBaseline:58, sleepGoalH:8,
  primaryGoal:'halfmarathon', primaryGoalLabel:'Halbmarathon',
  raceName:'Halbmarathon', raceDate:'2026-09-06', hmTargetMin:110,
  secondaryGoals:['70.3 · Frühjahr 27','Ironman <10h · 2028'],
  sports:['Laufen','Rad','Schwimmen','Gym'], level:'fortgeschritten',
  weeklyKm:30, longestRunKm:12,
  recoveryFocus:'Schlaf & HRV', nutritionFocus:'Protein 150–165 g',
  issues:['knee'], equipment:['Garmin/Wearable','Indoor Bike','Mini-Band','Foam Roller'],
  dataSources:['Strava','Garmin','Manuell'], coachingIntensity:'praezise'
};
var PROFILE=null;
...
function renderProfileScreen(){
  ...
  el.innerHTML='<div class="profhead"><div class="avatar">'+escH(initial)+'</div>'+
...
function openOnboarding(fresh){
  OB_FRESH=!!fresh;
  OB=fresh?{issues:[],sports:[],equipment:[],dataSources:[],secondaryGoals:[]}:JSON.parse(JSON.stringify(PROFILE||PROFILE_DEFAULTS));
  OB_I=0;renderOB();
}
...
function obFinish(){
  ...
  PROFILE=Object.assign({},PROFILE_DEFAULTS,PROFILE||{},OB);
