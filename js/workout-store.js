...
(function () {
  ...
  async function finishWorkout(summary) {
    ...
    clearSessionState();
    return res(true, { completed: true, loadStatus: loadStatus, durationMin: durationMin, sessionId: s.id }, null, (online() && s.id) ? 'supabase' : 'indexeddb', (online() && s.id) ? 'synced' : 'pending');
  }
