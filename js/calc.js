...
function evaluateLoadAndInterference(n,tt){
  var L=n.loads||{},spike=(L.load3!=null&&L.load7!=null&&L.load7>0&&L.load3/L.load7>1.4);
...
function applyDecisionCaps(score,n,ev,state,tt){
  var cap=100,hard=!!(n&&n.hardPlanned),S=ev.safety,P=ev.pdm;
...
function buildTrainingDecision(input){
  ...
  // Score: Komponenten von der UI (Messwerte), Caps zentral hier
  var rawScore=combineScore(i.components||{recovery:(c.readiness!=null?c.readiness:null)});
