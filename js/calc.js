...
const Calc={HM_KM,RACE_DATE,avg,median,sd,clampC,fmtPace,fmtTime,fmtDuration,paceZones,bmr,nutritionTargets,ewma,sessionLoad,acwr,
  weekKmTarget,effectiveKmTarget,runnaWeek,planStatus,activityDuplicate,racePhases,buildIntervals,swimPace100,racePhase,trendDir,readiness,ampel,hrvScoreOf,riegelHM,goalEngine,
