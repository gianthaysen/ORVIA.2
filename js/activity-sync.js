...
(function (root) {
  ...
  async function flushPendingActivities() {
    ...
    _flushing = true;
    var pushed = 0, failed = 0, skipped = 0, conflicts = 0;
    try {
    ...
    var res = { ok: failed === 0, pushed: pushed, failed: failed, skipped: skipped, conflicts: conflicts, remaining: store.pendingActivities().length };
