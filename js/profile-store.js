...
(function () {
  ...
  // Alter zeitzonensicher (lokales Datum), Geburtstag im aktuellen Jahr korrekt.
    ...
    if (birthDate) {
      ...
      if (m) {
        ...
        if (dt.getFullYear() === y && dt.getMonth() === mo - 1 && dt.getDate() === d) {
          ...
          if (md < 0 || (md === 0 && now.getDate() < d)) a--;
          if (a >= 0 && a < 120) return a;
          return null; // negativ / unrealistisch → ablehnen
        }
      }
      return ageEstimate != null ? ageEstimate : null; // ungültiges Datum → Schätzung
    }
    return ageEstimate != null ? ageEstimate : null;
  }
